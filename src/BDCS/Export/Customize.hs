...
runCustomizations :: MonadError String m => CSOverlay -> FSTree -> [Customization] -> m (CSOverlay, FSTree)
runCustomizations overlay tree customizations = foldM runCustomization (overlay, tree) customizations
 where
